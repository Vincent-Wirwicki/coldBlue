  ...
  return (
    <main className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center py-8 bg-black">
      <div className="relative grid grid-cols-6 grid-rows-6 gap-2 w-4/5 h-full bg-black border border-[#00FFFF]">
        ...
        <div className="col-start-4 row-start-6 text-neutral-500">
...
const MyLink = ({
  ...
  return (
    <NavLink
      className={`[&.active]:text-[#00FFFF] [&.active]:no-underline text-end line-through border-l border-neutral-500
 col-start-${col + 1}`}
      to={path}
    >
      {col + 1} | {title}
