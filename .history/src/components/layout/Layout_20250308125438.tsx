...
const Nav = ({
  ...
  return (
    <nav className="col-start-2 col-span-5  row-start-6 row-span-4 self-start text-neutral-500 w-full">
      <div className=" grid grid-cols-subgrid gap-2 h-full w-full">
        {/* <h1 className="">Lab</h1> */}
...
const MyLink = ({
  ...
  return (
    <NavLink
      ...
      className={`[&.active]:text-[#00FFFF] [&.active]:no-underline text-end line-through col-start-${
        col + 1
      }`}
      to={path}
    >
