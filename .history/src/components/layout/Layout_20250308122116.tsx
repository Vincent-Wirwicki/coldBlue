...
const Nav = ({
  ...
  return (
    <nav className="col-start-2 col-span-4  row-start-6 row-span-4 self-start text-neutral-500   gap-5  w-full">
      <div className=" grid grid-cols-subgrid  h-full w-full">
        {/* <h1 className="">Lab</h1> */}
...
const MyLink = ({
  ...
  return (
    <NavLink
      ...
      className={`[&.active]:text-[#00FFFF] [&.active]:no-underline self-end line-through col-start-${
        col + 1
      }`}
      to={path}
    >
