...
const Layout = ({
  ...
  return (
    <main className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center pb-28 ">
      <div className="flex flex-col justify-start items-center w-4/5 h-screen">
