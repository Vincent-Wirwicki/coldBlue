...
const Layout = ({
  ...
  return (
    <main className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center  ">
      <div className="flex flex-col justify-center items-center w-4/5 h-full border">
        {/* <h1 className="text-neutral-500"> LAB</h1> */}
        <h1>
          Cold <span className="slabo">blue</span>
        </h1>
        <div className="min-w-[600px] h-[600px] border border-neutral-500 p-2">
          <Outlet />
        </div>
        <Nav paths={paths} />
      </div>
