...
const Layout = ({
  ...
  return (
    <main className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center py-8 bg-[#00FFFF]">
...
const MyLink = ({
  ...
  return (
    <NavLink
      className={`[&.active]:text-[#00FFFF] [&.active]:no-underline text-end line-through border-r
 col-start-${col + 1}`}
      to={path}
    >
      {col + 1} | {title}
