  ...
  return (
    <main className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center  py-4">
      <div className="relative grid grid-cols-6 grid-rows-6 gap-2 w-4/5 h-full">
        ...
        <h1 className="col-start-2 row-start-6 text-neutral-500">cold blue</h1>
        <Nav paths={paths} />
        <div className="absolute col-start-2 row-start-2 row-span-4 col-span-4 w-full h-full border-y border-neutral-500">
          <Outlet />
        </div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-2 col-start-1 "></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-2 col-start-6 justify-self-end"></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-1 col-start-1 "></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-1 col-start-6 justify-self-end"></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-3 col-start-1 "></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-3 col-start-6 justify-self-end"></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-4 col-start-1 "></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-4 col-start-6 justify-self-end"></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-5 col-start-1 "></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-5 col-start-6 justify-self-end"></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-6 col-start-1 "></div>
        <div className="w-[10px] h-[10px] border border-[#00FFFF] row-start-6 col-start-6 justify-self-end"></div>
...
const MyLink = ({
  ...
  return (
    <NavLink
      className={`[&.active]:text-[#00FFFF] [&.active]:no-underline text-end line-through 
 col-start-${col + 1}`}
      to={path}
    >
      {col + 1} | {title}
