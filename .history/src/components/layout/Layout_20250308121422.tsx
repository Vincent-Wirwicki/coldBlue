  ...
  return (
    <main className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center  py-4">
      <div className="relative grid grid-cols-6 grid-rows-6 gap-2 w-4/5 h-full">
        ...
        <h1 className="col-start-3 self-end text-start">blue</h1>

        <div className="absolute col-start-2 row-start-2 row-span-4 col-span-4 w-full h-full border-y">
          <Outlet />
        </div>
        <Nav paths={paths} />
      </div>
...
const Nav = ({
  ...
  return (
    <nav className="col-start-2 col-span-4 row-start-6 row-span-4 self-start text-neutral-500 flex flex-col  gap-5  h-full">
