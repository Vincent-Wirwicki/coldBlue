    ...
    <LayoutGroup>
      <nav className="relative col-start-2 col-span-4 grid grid-cols-subgrid row-start-1 self-end text-end text-neutral-200 w-full ">
        ...
        {activeIndex !== null && (
          <motion.div
            layoutId="activeTab"
            className="absolute left-1/2 h-full w-4/5 bg-[#00FFFF] z-0 "
            initial={false}
            style={{
  ...
  return (
    <NavLink
      className={({ isActive }) =>
        ...
        }relative transition-colors w-full delay-200 text-center border-neutral-800 tracking-widest z-10 col-start-${
          col + 1
        }`
      }
      to={path}
