...
const Layout = ({
  ...
  return (
    <main className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center">
      <div className="flex flex-col justify-center items-center gap-2 w-4/5 h-4/5 border">
        <h1>A noise observation</h1>
        <Outlet />
        <Nav paths={paths} />
      </div>
    </main>
...
const Nav = ({
  ...
  return (
    <nav className="text-neutral-500 flex flex-col justify-center items-end gap-5 p-2 pt-5  ">
