  ...
  return (
    <main className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center  py-4">
      <div className="relative grid grid-cols-6 grid-rows-6 gap-2 w-4/5 h-full">
        ...
        <h1 className="col-start-1 row-start-6 grid grid-cols-subgrid self-start text-end">
        ...
        <div className="w-[10px] h-[10px] bg-[#00FFFF] row-start-3 justify-self-end"></div>
        <div className="w-[10px] h-[10px] bg-[#00FFFF] row-start-4 justify-self-end"></div>
        <div className="w-[10px] h-[10px] bg-[#00FFFF] row-start-5 justify-self-end"></div>
        <div className="w-[10px] h-[10px] bg-[#00FFFF] row-start-3 col-start-6 justify-self-start"></div>
        <div className="w-[10px] h-[10px] bg-[#00FFFF] row-start-4 col-start-6 justify-self-start"></div>
        <div className="w-[10px] h-[10px] bg-[#00FFFF] row-start-5 col-start-6 justify-self-start"></div>
