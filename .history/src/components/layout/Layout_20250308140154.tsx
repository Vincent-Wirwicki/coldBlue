  ...
  return (
    <main className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center  py-4">
      <div className="relative grid grid-cols-6 grid-rows-6 gap-2 w-4/5 h-full">
        ...
        <h1 className="col-start-3 row-start-6 grid grid-cols-subgrid self-start text-end">
          <span>cold</span> <span className="col-start-4">blue</span>
        </h1>
        <Nav paths={paths} />
        ...
        <div className="w-[10px] h-[10px] rounded-full bg-[#00FFFF] row-start-6 col-start-5 justify-self-start"></div>
        <div className="w-[10px] h-[10px] rounded-full bg-[#00FFFF] row-start-6 col-start-5 justify-self-end"></div>
        <div className="w-[10px] h-[10px] rounded-full bg-[#00FFFF] row-start-6 col-start-2 justify-self-end"></div>
        <div className="w-[10px] h-[10px] rounded-full bg-[#00FFFF] row-start-6 col-start-1 justify-self-end"></div>
