    ...
    <LayoutGroup>
      <nav className="relative col-start-2 col-span-4 grid grid-cols-subgrid row-start-1 self-end text-end text-neutral-200 w-full ">
        ...
        {activeIndex !== null && (
          <motion.div
            layoutId="activeTab"
            className="absolute h-full w-full bg-[#00FFFF] z-0 p-1"
            initial={false}
            style={{
  ...
  return (
    <NavLink
      className={({ isActive }) =>
        ...
        ${
          col === 0 ? "border-l" : "border-r "
        }relative transition w-full delay-200 text-center  tracking-widest z-10 bg-blend-difference col-start-${
          col + 1
        }`
      }
      to={path}
