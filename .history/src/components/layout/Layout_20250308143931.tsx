...
const Layout = ({
  ...
  return (
    <main className="absolute top-0 left-0 w-screen h-screen flex justify-center items-center py-8 bg-black">
      <div className="relative grid grid-cols-6 grid-rows-6 gap-2 w-4/5 h-full bg-black border border-[#00FFFF]">
        ...
        <Nav paths={paths} />
        <div className="absolute col-start-2 row-start-2 row-span-4 col-span-4 w-full h-full border-y border-[#00FFFF]">
          <Outlet />
        </div>
        <div className="col-start-3 row-start-6 text-neutral-500">
          A vjing collectif
        </div>
        <div className="col-start-5 row-start-6 text-neutral-500">Paris</div>
