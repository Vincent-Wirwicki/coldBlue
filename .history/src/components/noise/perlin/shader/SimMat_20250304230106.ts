...
float sdCircle( vec2 p, float r )
{
    ...
    float box = sdBox(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime*2. , .001) , vec2(time2 * 0.25 +0.2)) ;
    float box2 = sdBox(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime*2. , .001) , vec2(time*0.015 ,+0.5)) ;
