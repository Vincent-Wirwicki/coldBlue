...
float tetrahedronSDF(vec3 p, float h)  {
    ...
    for(int i = 0; i<4; i++){
          ...
          if(tl1 < 1.0) {
n3 += cnoise(vec3(pos.xy * vec2(tl1,.5)  , uTime*0.75) + vec3(0.,uTime*0.1,0.)) * 15. * amp2;    } 
else if(tl1 < 2.0) {
n3 += cnoise(vec3(pos.xy * vec2(1.,.5)  , uTime*0.75) + vec3(0.,uTime*0.1,0.)) * 15. * amp2;    } else if(tl1 < 2.0) {
    } else {
n3 += cnoise(vec3(pos.xy * vec2(0.,.5)  , uTime*0.75) + vec3(0.,uTime*0.1,0.)) * 15. * amp2;    } else if(tl1 < 2.0) {
    }
    }
