...
float sdEquilateralTriangle( in vec2 p, in float r )
{
    ...
    float box = sdBox(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.15) ) - mod(uTime*2. , .001) , vec2(0.75)) ;
      float triangle = sdEquilateralTriangle(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime , .01), 0.75);
