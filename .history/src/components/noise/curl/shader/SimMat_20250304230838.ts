...
float sdBox( in vec2 p, in vec2 b )
{
    ...
    void main(){
      ...
      float box = sdBox(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime , .01) , vec2(0.5,0.1)) ;
            float box2 = sdBox(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime , .01) , vec2(0.05,0.5)) ;
