...
float sdCircle( vec2 p, float r )
{
    ...
    float box = sdBox(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime*2. , offset.z *0.01) , vec2(time2.5)) ;
    float circle = sdCircle(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime*2. , offset.z *0.01),  time2 *0.5  +.25);
    ...
    vel *= n  *0.5 *n3 * mix(box, circle, time2) ;
