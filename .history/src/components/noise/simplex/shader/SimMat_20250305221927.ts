...
float sdCircle( vec2 p, float r )
{
    ...
    float circle = sdCircle(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime*2. , offset.z *0.01),  time * .25 + 0.5);
    ...
    vel *= n  *0.5 *n3 * mix(length(box)/n, length(circle)/n, time2 * time2) ;
