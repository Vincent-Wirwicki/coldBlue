...
float sdBox( in vec2 p, in vec2 b )
{
    ...
    float box = sdBox(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime*2. , offset.z *0.01) , vec2(0.75)) ;
    ...
    float n = snoise(vec3(pos.xy * vec2(2.,  floor(sc)) + vec2(1., uTime*0.25) , uTime*0.15)   ) * amp2 * 2.;
    float n2 = snoise(vec3(pos.xy + vec2(1., uTime*0.5) , uTime*0.75)   )*.5;
