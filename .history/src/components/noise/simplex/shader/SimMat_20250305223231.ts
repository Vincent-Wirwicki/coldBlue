...
float sdCircle( vec2 p, float r )
{
    ...
    float circle = sdCircle(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime*2. , offset.z *0.01),  time * 0.075);
    ...
    for(int i = 0; i<4; i++){
      ...
      c2 -= sdCircle(pos.xy - smoothstep(1.9999, 1.9998, length(pos.xy -0.5) ) - mod(uTime*2. , offset.z *0.01),  time  + 0.025*float(i));
    }
